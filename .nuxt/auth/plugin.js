...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/api/account/login","method":"post","propertyName":"token"},"logout":{"url":"/api/account/logout","method":"post"},"user":{"url":"http://localhost:8080/api/account/info","method":"get","propertyName":"username"}},"tokenRequired":true,"tokenType":"","_name":"local"}))
